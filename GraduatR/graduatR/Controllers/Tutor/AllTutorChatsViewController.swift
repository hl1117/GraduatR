//
//  AllTutorChatsViewController.swift
//  graduatR
//
...
class AllTutorChatsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "TutorChatCell", for: indexPath) as! TutorChatCell
        if (showSearchResults){
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            ...
            let vc = segue.destination as! ChatTutorViewController
