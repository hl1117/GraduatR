//
//  ParentCoursesViewController.swift
//  graduatR
//
...
class ParentCoursesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ParCourseCell", for: indexPath) as! ParCourseCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let vc = segue.destination as! ParentCDetailViewController
